...
For replicating the analysis and usage, clone this GitHub repository and run the following command at the root directory of the cloned repository folder.
