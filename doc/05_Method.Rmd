...
The programming language [@Python] and the scikit-learn [@scikit-learn] are used to build our machine learn model.

The Python programming language [@pypi] and the following python packages were used to perform the analysis:Altair[@vanderplas2018altair], SKlearn [@pedregosa2011scikit], knitr [@k nitr] and tidyverse [@tidyverse]. 
